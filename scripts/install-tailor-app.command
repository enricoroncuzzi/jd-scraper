...
echo ""
echo "=============================================================="
echo "ONE-TIME PERMISSION NEEDED so the click can read your files:"
echo "  1. In the window opening now (Privacy & Security > Full Disk Access),"
echo "     click '+' and add:  ~/Applications/Tailor.app"
echo "     (or drag it in from Finder), then toggle it ON."
echo "  2. Without this, clicking a tailor: link fails with"
echo "     'Operation not permitted' (see /tmp/tailor-app.log)."
echo "=============================================================="
open "x-apple.systempreferences:com.apple.preference.security?Privacy_AllFilesAccess" || true
