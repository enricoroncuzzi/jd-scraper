...
- **Test-driven throughout**: 354 tests (`.venv/bin/python -m pytest tests/`), every module built red to green.
...
|---|---|---|
| Automated tests | **354** | `.venv/bin/python -m pytest tests/ --collect-only -q` |
